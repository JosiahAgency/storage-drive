            ...
            <DialogContent className='shad-dialog-button'>
                ...
                {['rename', 'delete', 'share'].includes(value) && (
                    <DialogFooter className='flex flex-col gap-3 md:flex-row'>
                        ...
                        <Button onClick={handleActionClick} className='modal-submit-button'>
                            <p className="capitalize">{value}</p>
                            {isLoading && (
                                <Image src='/icons/loader.svg' alt='loading' width={24} height={24} className='animate-spin' />
                            )}
                        </Button>
                    </DialogFooter>
                )}
            ...
            <DropdownMenu open={isDropdownOpen} onOpenChange={setisDropdownOpen}>
                ...
                <DropdownMenuContent className=''>
                    ...
                    {actionsDropdownItems.map((actionItem) => (
                        <DropdownMenuItem key={actionItem.label} className='shadow-dropown-item' onClick={() => {
