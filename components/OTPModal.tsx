            ...
            <AlertDialogContent className='shad-alert-dialog'>
                <AlertDialogHeader className='relative flex justify-center'>
                    <AlertDialogTitle className='h2 text-center'>
                        Enter your OTP
                        <Image src='/icons/close-dark.svg' alt='close' width={20} height={20} onClick={() => setIsOpen(false)} className='otp-close-button' />
                    </AlertDialogTitle>
                ...
                <InputOTP maxLength={6} value={password} onChange={setPassword}>
                    <InputOTPGroup className='shad-otp'>
                        <InputOTPSlot index={0} className='shad-opt-slot' />
                        <InputOTPSlot index={1} className='shad-opt-slot' />
                        <InputOTPSlot index={2} className='shad-opt-slot' />
                        <InputOTPSlot index={3} className='shad-opt-slot' />
                        <InputOTPSlot index={4} className='shad-opt-slot' />
                        <InputOTPSlot index={5} className='shad-opt-slot' />
                    </InputOTPGroup>
                </InputOTP>
                <AlertDialogFooter>
